...
with gr.Blocks(css=css) as demo:
    ...
    gr.HTML("""
            <div style="top-margin:50px; border-top: 1px solid #303030;">
              ...
              <a href="https://www.buymeacoffee.com/Omnibus" target="_blank"><img src="https://huggingface.co/spaces/Omnibus/Finetuned-Magic_dev/blob/main/default-yellow-omnibus.webp" alt="Buy Me A GPU" style="height: 50px !important;width: 00px !important;" ></a><br><br>
            </div>
            """)
