...
with gr.Blocks(css=css) as demo:
    ...
    gr.HTML("""
            <div style="top-margin:50px; border-top: 1px solid #303030;">
              ...
              <a href="https://www.buymeacoffee.com/Omnibus" target="_blank"><img src="https://cdn.buymeacoffee.com/buttons/v2/default-blue.png" alt="Buy Me A Coffee" style="height: 45px !important;width: 162px !important;top-margin: 50px; !important;" ></a><br><br>
            </div>
            """)
